...
chord_labels = chunk_send.chunk_sender(peaks=peaks, z_boundaries=z_boundaries, aud=y, location=location,method = 'cqt', name=name.split('.')[0],hop_length= 512,binsPerOctave= 36,sr=44100)
